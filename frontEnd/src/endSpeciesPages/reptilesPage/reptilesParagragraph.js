export const ReptilesMainParagraph = () => {
    return (
        <div>
...
export const YangtzeGiantSoftsellParagraph = () => {
    return (
        <div>
            One of the most critically endangered species of turtles in the world since the 1980s is the Yangtze giant softshell turtle. It only survives in two lakes in northern Vietnam. Conservationists estimate that there are now only 3 remaining wild turtles in the world.
            These turtles are at in brink of extinction due to habitat loss, hunting for local consumption and pets, and the use of their carapace and bones in alternative medicine.
        </div>  
    );
}
...
export const TurtleImportanceParagraph = () => {
    return (
        <div>
            <b>Helps to clean the environment, balances ocean ecosystem and other species:</b>
            <br></br>
            <br></br>
            ...
            {/* https://wildlifesense.com/en/sea-turtles/#:~:text=By%20foraging%20on%20all%20of,at%20a%20relatively%20stable%20level. */}
        </div>  
    );
}


export const CrocodileImportanceParagraph = () => {
    return (
        <div>
            <b>Stops invasive species, balance foodchain and helps other species and Economy:</b>
            <br></br>
            <br></br>
...
export const LizardsImportanceParagraph = () => {
    return (
        <div>
            <b>Lizards control ecosystem, helps plants and provides food:</b>
            <br></br>
            <br></br>
            ...
            {/* https://www.rd.com/article/lizards-misunderstood-and-needed/ */}
        </div>  
    );
}


export const SnakesImportanceParagraph = () => {
    return (
        <div>
            <b>Lizards and snakes venom are used for medical treatments:</b>
            <br></br>
            <br></br>
            Some types of lizard species like the western fence lizard prevent Lyme disease.
            Studies have shown that reptiles and small mammels serve as hosts for the ticks. But, researchers has found that a protein in the lizards blood kills the Lyme-causing bacteria in the ticks, making it harmless to humans. 
            <br></br>
            <br></br>
            Some lizards have toxic waste product called biliverdin in their blood, making their blood green, which somehow the lizards are able to tolerate without being harm. Scientists and biologists suspects that it might have applications in humans for blood-related conditions such as malaria and jaundice.
            <br></br>
            <br></br>
            Few lizards are venomous, such as the Gila monster, Mexican beaded lizard, and the Komodo dragon. Science may have found a use for their venomous compounds. Recent research from Australia is exploring ways the venom affects certain proteins in the blood in order to treat blood clotting disorders.
            ...
            <br></br>
            <br></br>
            Some snake venom affects blood pressure and blood clotting. Scientists can use this snake venom to develop new drugs to treat illnesses. In fact, the proteins in snake venom has been used to treat many conditions. For example, cancer, pain, high blood pressure, heart attacks, strokes, Alzheimer's disease, and Parkinsons disease.
        </div>  
    );
}