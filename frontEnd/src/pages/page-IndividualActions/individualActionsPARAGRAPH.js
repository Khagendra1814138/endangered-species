export const IndividualActionParagaph1 = () => {
    return (
        <div>
            ...
            But we should do our part as well to protect the endangered species from extinction and doing so can protect our ecosystem. 
            There are many individual actions that we can take everyday to make a positive impact on these endangered species.
            We can take small steps everyday that can reduce our carbon footprint such as reducing your fossil fuel emmission and electric enengy consumption.
        </div>  
    );
}

export const ShareInformationPARAGRAPH = () => {
    return (
        <div>
...
export const PurchasingHabitPARAGRAPH = () => {
    return (
        <div>
...
export const RecycleReuseDisposePARAGRAPH = () => {
    return (
        <div>
...
export const SupportOrganisationPARAGRAPH = () => {
    return (
        <div>
...
export const ReduceDairyMeatProductsPARAGRAPH = () => {
    return (
        <div>
...
export const SmartTransportPARAGRAPH = () => {
    return (
        <div>
...
export const ReduceEnergyConsumptionPARAGRAPH = () => {
    return (
        <div>
...
export const KeepGardenHealthyPARAGRAPH = () => {
    return (
        <div>
...
export const UseYourVoicePARAGRAPH = () => {
    return (
        <div>
...
export const TravelCompassionatlyPARAGRAPH = () => {
    return (
        <div>
