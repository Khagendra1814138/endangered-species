      ...
      <body className='pageBodyFrame'>
        <div className='container'>
          ...
          <paragragraph style={{fontSize: `${fontSize}px`}} className = {darkMode ? "paragpaphLrg-Dark" : "paragpaphLrg-Light"}>
            ...
            Do you research and find the one that suits your interests and join them to continue supporting their work to support the endangered species.
          ...
          <box className = "box">
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}>Support World Wildlife Fund (WWF)</label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
              ...
              <Link className={darkMode ? "takeActionBtn-Dark" : "takeActionBtn-Light"} 
                to={{ pathname: "https://support.wwf.org.uk/"}} target="_blank">Visit WWF
              </Link>
            </box>
          </box>
                   
          <div className= {darkMode ? "videoFrame-Dark" : "videoFrame-White"}>
        ...
        <div className={darkMode ? "container" : "container2"}>
          <box className = "box">
            <image className={darkMode ? "imageMedium-Dark" : "imageMedium-Light"}>
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}> Support IUCN </label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
        ...
        <div className='container'>
          <box className = "box"> 
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}>Support One Tree Planted (OTP)</label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
        ...
        <div className={darkMode ? "container" : "container2"}>
          <box className = "box">
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}>Use Ecosia Search Engine</label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
        ...
        <div className='container'>
          <box className = "box">
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}>Support The Ocean Cleanup (TOC)</label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
        ...
        <div className={darkMode ? "container" : "container2"}>
          ...
          <image className={darkMode ? "imageMedium-Dark" : "imageMedium-Light"}>
            ...
            <box className={darkMode ? "threatParagraphFrame-Dark" : "threatParagraphFrame-Light"}>
              <label className={darkMode ? "threatTitle-Dark" : "threatTitle-Light"}>Support Ocean Conservancy (OC)</label>
              <paragragraph style={{fontSize: `${fontSize}px`}} className={darkMode ? "actionParagraph-Dark" : "actionParagraph-Light"}>
