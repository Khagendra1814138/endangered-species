...
export const PlasticPollutionPARAGRAPH = () => {
    return (
        <div>
...
export const ChemicalPollutionPARAGRAPH = () => {
    return (
        <div>
...
export const InfrastructuresPARAGRAPH = () => {
    return (
        <div>
...
export const ClimateChangePARAGRAPH = () => {
    return (
        <div>
...
export const IllegalTradingPARAGRAPH = () => {
    return (
        <div>
...
export const HabitatDistructionPARAGRAPH = () => {
    return (
        <div>
...
export const InvasiveSpeciesPARAGRAPH = () => {
    return (
        <div>
...
export const OverFishingPARAGRAPH = () => {
    return (
        <div>
...
export const OilGasDevelopmentPARAGRAPH = () => {
    return (
        <div>
